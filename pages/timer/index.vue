<template>
    <div class="h-full w-full md:h-screen md:w-screen">
        <div class="flex flex-col py-5">
            ...
            <div class="mx-auto" v-if="timeLeft > 0">
                <a href="#" :class="{
                  'transition':true,
                  'duration-300':true,
                  'ease-in-out':true,
                ...
                <a href="#" :class="{
                  ...
                  'px-6':true,
                  'mx-2':true,
                  'hover:bg-red-600':title!=='',
                  'cursor-default':title==='',
                  'focus:outline-none':true,
                  'active:outline-none':true,
                  }" @click="resetTimer"> Reset </a>
                <nuxt-link to="/user" class="hover:bg-gray-700 transition duration-300 ease-in-out bg-gray-500 text-white font-bold font-sans rounded-full py-2 px-6 mx-2 focus:outline-none active:outline-none"> History </nuxt-link>
            </div>
            <div v-else>
